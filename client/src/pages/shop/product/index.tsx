    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => setLocation("/shop")} className="btn-primary">Return to Shop</Button>
        </div>
      </div>
    );
  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
                    ...
                    {product.images.map((img: string, idx: number) => (
                      <button
                        ...
                        className={`relative rounded-md overflow-hidden h-20 w-20 border-2 ${
                          idx === activeImageIndex ? "border-blue-500" : "border-transparent"
                        }`}
                      >
                        <img
                          src={img}
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mb-2">By {product.organization}</p>
                  ...
                  <div className="text-3xl font-bold text-sky-700">${product.price}</div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center">
                      ...
                      <input
                        id="quantity"
                        type="number"
                        className="h-9 w-16 rounded-none text-center border-y border-x-0 border-input [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                        min={1}
                        max={10}
                        value={quantity}
                        onChange={(e) => {
            ...
            <div className="border-t">
              <Tabs value={activeTab} onValueChange={setActiveTab} className="p-6">
                ...
                <TabsContent value="reviews" className="space-y-6">
                  <h3 className="text-lg font-semibold">Customer Reviews</h3>                  {product.reviews.length > 0 ? (
                    product.reviews.map((review: any) => (
                      <Card key={review.id} className="bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl">
